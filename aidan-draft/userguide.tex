...
\begin{tabular}{ l r }
C-c C-l filename.bel & Load \\
C-c C-x command & Execute Command \\
C-c C-c & Compile \\
C-c C-s int id & Split, where \texttt{id} specifies the variable \\
C-c C-i int & Variable introduction \\
C-c C-t & Type-check at cursor location \\
\end{tabular}
